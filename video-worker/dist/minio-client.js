...
exports.BUCKET_THUMBNAILS = exports.BUCKET_VIDEOS = exports.minioClient = void 0;
...
async function getPresignedGetUrl(bucket, key, ttl = 3600) {
    return exports.minioClient.presignedGetObject(bucket, key, ttl);
}
async function uploadBuffer(bucket, key, buffer, mimeType) {
    await exports.minioClient.putObject(bucket, key, buffer, buffer.length, {
